...
1. **Supabase 대시보드 URL 확인**
   - 브라우저 주소창의 URL 확인
   - 형식: `https://app.supabase.com/project/[PROJECT-REF]`
   - `[PROJECT-REF]` 부분이 Project Reference ID입니다

2. **또는 Settings → General**
   - Settings → General 탭
   - "Reference ID" 확인
...
```
**중요**: `[PROJECT-REF]`를 1단계에서 확인한 실제 값으로 교체!

```env
JWT_SECRET=[3.3에서 생성한 값]
```

```env
ENCRYPTION_KEY=[3.3에서 생성한 값]
```
...
- [x] 프로젝트 생성 완료
- [x] SQL 스키마 실행 완료
- [x] Database password 확인: `blockkwave0806!`
